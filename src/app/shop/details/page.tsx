        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div>
            {product.images.length > 0 ? (
              ...
              <div className="aspect-square rounded-lg overflow-hidden mb-6 bg-[#18181c] flex items-center justify-center">
        ...
        <div className="mb-20">
          ...
          {relatedProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-xl text-[#bdbdbd]">No related products available</p>
            </div>
          )}
        </div>
      </div>
