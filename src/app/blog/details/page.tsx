...
const BlogDetailsPage = () => {
  ...
  const blogPost = {
    ...
    content: `
      ...
      <h2 className="text-2xl font-bold text-white my-6">The Foundation: Quality Ingredients</h2>
      ...
      <h2 className="text-2xl font-bold text-white my-6">Timing is Everything</h2>
      ...
      <h2 className="text-2xl font-bold text-white my-6">The Perfect Pairing: Sauce and Pasta</h2>
      ...
      <h2 className="text-2xl font-bold text-white my-6">Final Touches</h2>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <article className="bg-[#18181c] rounded-lg overflow-hidden border border-[#23232a] mb-12">
          ...
          <div className="p-8 md:p-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-8">{blogPost.title}</h1>
            ...
            {relatedPosts.map((post) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-white group-hover:text-[#e2b279] transition-colors duration-300 mb-3">
                    {post.title}
                  </h3>
