...
export default function Footer() {
  return (
    <footer className={`w-full bg-[#111115] text-[#fff] pt-0 pb-0 mt-20 ${etarBellotaFont.variable}`} style={{ fontFamily: 'var(--font-etar-bellota), sans-serif' }}>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 pt-16 sm:pt-20 pb-12 sm:pb-16 border-b border-[#23232a] relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 border-b border-[#23232a]">
        {/* Quick Link */}
        <div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between px-4 sm:px-6 py-6 sm:py-8 gap-4 sm:gap-0">
        ...
        <div className="flex gap-3 mt-4 sm:mt-0 items-center">
          <a href="#" aria-label="Facebook" className="w-10 h-10 flex items-center justify-center rounded-full border border-[#e2b279] bg-transparent hover:bg-[#e2b279] group transition-all duration-300">
            <svg className="w-5 h-5 text-[#e2b279] group-hover:text-[#111115] transition-all duration-300" fill="currentColor" viewBox="0 0 24 24"><path d="M2.675 0h-21.35C.595 0 .592 0 1.326v21.348C0 23.406.595 24 1.325 24h11.495v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.406 24 22.674V1.326C24 .592 23.406 0 22.675 0"/></svg>
          </a>
